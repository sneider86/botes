          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="form_crear_cliente" action="../controllers/contoller.php" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="txttelefono">Paises <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select id="paises" name="paises" class="form-control">
                                ...
                                if($rspaises->num_rows>=1){
                                  ...
                                  while($item = $rspaises->fetch_assoc()){
                                    $selected = ($item['id']==43)?"selected='selected'":'';
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="txtciudad">Ciudad <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <div class="x_content">
                    <div class="col-lg-8 col-md-6 col-sm-6 col-xs-6">
                      <form id="form_reserva" action="../controllers/contoller.php" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <input type="hidden" name="asesor" value="<?php echo (isset($_SESSION['idUser']))?$_SESSION['idUser']:0; ?>" />
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="desc">Observaciones </span>
                              </label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
